  ...
  const handleSenData = (e) => {
    ...
    formik.validateForm().then((errors) => {
      if (Object.keys(errors).length > 0) {
        ...
        addNewOrder(data.information_reprot_data.id,data, user.token, navigate, setIsLoading);
                      ...
                      <td>
                        {item.status === true && (
                          <input
                            ...
                            onChange={(e) => handleChangPriceAction(e, item.id)}
                          />
                        )}
                      </td>
                    </tr>
